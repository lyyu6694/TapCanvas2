...
const enTranslations = {
  ...
  '悬停“+”打开添加面板，先加 image / 视频 / 角色等节点，然后在画布上连线组合成工作流。': 'Hover "+" to open the add panel. Start with image/video/character nodes, then connect them into a workflow.',
  ...
  '点“小T”直接用自然语言描述需求：它会帮你自动创建/连接节点并执行，适合快速产出第一版。': 'Click "T" and describe what you want in natural language. It can create/connect nodes and run them for a quick first draft.',
